...
static void sys_write(const char*s,unsigned long n){__asm__ volatile("int $0x80"::"a"(4),"b"(1),"c"(s),"d"(n):"memory");}
static void sys_exit(int c){__asm__ volatile("int $0x80"::"a"(1),"b"(c));__builtin_unreachable();}
