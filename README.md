...
| **S.T.A.L.K.E.R.: Clear Sky - Enhanced Edition** | DX11 | Smooth, high FPS | Much better than original. Fast loading, high FPS. Known issues: fire particle texture glitches; cutscenes render as bright yellow rectangles with black checker pattern (audio plays, Escape to skip). Enhanced Editions are the way to go over original X-Ray engine. |
...
| **S.T.A.L.K.E.R.: Shadow of Chornobyl - Enhanced Edition** | DX11 | Smooth, high FPS, ultrawide | Same cutscene rendering bug as Clear Sky EE (yellow rectangles, Escape to skip). Gameplay is smooth, looks great at full ultrawide. Enhanced Editions recommended over originals. |
